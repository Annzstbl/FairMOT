...
if __name__ == '__main__':
    data_val = '/data3/publicData/MOT/crowdhuman/images/val'
    label_val = '/data3/publicData/MOT/crowdhuman/labels_with_ids/val'
    ann_val = '/data3/publicData/MOT/crowdhuman/annotation_val.odgt'
    data_train = '/data3/publicData/MOT/crowdhuman/images/train'
    label_train = '/data3/publicData/MOT/crowdhuman/labels_with_ids/train'
    ann_train = '/data3/publicData/MOT/crowdhuman/annotation_train.odgt'
