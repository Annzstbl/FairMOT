...
CUDA_VISIBLE_DEVICES=2 python track.py mot --load_model ../models/mix_mot17_half_dla34.pth --conf_thres 0.35 --val_mot17 True --nms_type '5' --nms_iou_th 0.8 --exp_id debug